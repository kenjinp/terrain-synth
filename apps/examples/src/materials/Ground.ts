import { Material, MeshPhysicalMaterial, RepeatWrapping, Texture } from "three"
 ...
 *   `MeshLambertMaterial`.
 */
export const generateBlendedMaterial = function (
  textures: {
    texture: Texture
    levels?: number[]
    glsl?: string
  ...
  function glslifyNumber(n: number) {
    return n === (n | 0) ? n + ".0" : n + ""
  }
  ...
  var mat = material || new MeshPhysicalMaterial()
