...
#define HEIGHT_RAY 8e2 /* rayleigh height */
#define HEIGHT_MIE 1.2e2 /* and mie */
#define HEIGHT_ABSORPTION 30e2 /* at what height the absorption is at it's maximum */
#define ABSORPTION_FALLOFF 4e2 /* how much the absorption decreases the further away it gets from the maximum height */
