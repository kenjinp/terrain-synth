...
def train_fn(
    ...
    for batch_idx, (real, _) in enumerate(loop):
        ...
        if batch_idx % 500 == 0:
            ...
            gan.save_image(fixed_fakes, f"step-{step}")
            tensorboard_step += 1
...
def train(gan, get_loader, batch_sizes, start_train_at_img_size, progressive_epochs, save_model, lambda_gp):
    device = gan.device
    gen = gan.generator
    ...
    for num_epochs in progressive_epochs[step:]:
        ...
        for epoch in range(num_epochs):
            ...
            print("~I should save checkpoint here~")
            if save_model:
                gan.save_checkpoint()
